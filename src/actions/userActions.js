...
export const logout = () => async (dispatch) => {
    try {
        ...
        await axios.get("/admin/removeRefreshToken")
...
export const fetchEditUser = (id) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`/user/get-edit-user/${id}`)
...
export const addAddress = (payload) => async (dispatch) => {
    try {
        ...
        await axios.post("/user/shipping-address", payload)
...
export const editUserDetails = (payload) => async (dispatch) => {
    try {
        ...
        await axios.post("/user/details", payload)
...
export const addTemporaryAddress = (payload) => async (dispatch) => {
    try {
        ...
        await axios.post("/user/checkout-address", payload)
